...
density_final_rmse_df.to_csv('redox_mdm_embed_5runs_RMSE_df.csv', header=False, index=False)
density_final_rmse_bin_df = pd.DataFrame(density_final_rmse_bin_ls)
density_final_rmse_bin_df.to_csv('redox_mdm_embed_5runs_bin_RMSE_df.csv', header=False, index=False)
density_final_R2_df = pd.DataFrame(density_final_R2_ls)
density_final_R2_df.to_csv('redox_mdm_embed_5runs_R2_df.csv', header=False, index=False)
density_final_R2_bin_df = pd.DataFrame(density_final_R2_bin_ls)
density_final_R2_bin_df.to_csv('redox_mdm_embed_5runs_bin_R2_df.csv', header=False, index=False)
density_final_in_bin_count_df = pd.DataFrame(density_final_in_bin_count_ls)
density_final_in_bin_count_df.to_csv('redox_mdm_embed_5runs_in_bin_count_df.csv', header=False, index=False)

final_rmse_out_df = pd.DataFrame(final_rmse_out_ls)
final_rmse_out_df.to_csv('redox_mdm_embed_5runs_out_RMSE_df.csv', header=False, index=False)
final_R2_out_df = pd.DataFrame(final_R2_out_ls)
final_R2_out_df.to_csv('redox_mdm_embed_5runs_out_R2_df.csv', header=False, index=False)
...
random_final_rmse_ls, random_final_rmse_bin_ls, random_final_R2_ls, random_final_R2_bin_ls, random_final_in_bin_count_ls, random_final_rmse_out_ls, random_final_R2_out_ls = \
    get_AL_RMSE_matrix(x_train, y_train, x_val, y_val, x_test, y_test, similarity_train_embeddings,
                              pca_space_train, pca_space_val, pca_space_test,
                              starting_percs, nums_mols_to_add, 3, 5, 5, 3, True)

random_final_rmse_df = pd.DataFrame(random_final_rmse_ls)
random_final_rmse_df.to_csv('redox_mdm_random_5runs_RMSE_df.csv', header=False, index=False)
random_final_rmse_bin_df = pd.DataFrame(random_final_rmse_bin_ls)
random_final_rmse_bin_df.to_csv('redox_mdm_random_5runs_bin_RMSE_df.csv', header=False, index=False)
random_final_R2_df = pd.DataFrame(random_final_R2_ls)
random_final_R2_df.to_csv('redox_mdm_random_5runs_R2_df.csv', header=False, index=False)
random_final_R2_bin_df = pd.DataFrame(random_final_R2_bin_ls)
random_final_R2_bin_df.to_csv('redox_mdm_random_5runs_bin_R2_df.csv', header=False, index=False)
random_final_in_bin_count_df = pd.DataFrame(random_final_in_bin_count_ls)
random_final_in_bin_count_df.to_csv('redox_mdm_random_5runs_in_bin_count_df.csv', header=False, index=False)


random_final_rmse_out_df = pd.DataFrame(random_final_rmse_out_ls)
random_final_rmse_out_df.to_csv('redox_mdm_random_5runs_out_RMSE_df.csv', header=False, index=False)
random_final_R2_out_df = pd.DataFrame(random_final_R2_out_ls)
random_final_R2_out_df.to_csv('redox_mdm_random_5runs_out_R2_df.csv', header=False, index=False)
'''
