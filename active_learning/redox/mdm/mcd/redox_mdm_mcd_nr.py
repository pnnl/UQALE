...
density_final_rmse_ls, density_final_R2_ls = get_AL_RMSE_matrix(x_train, y_train, x_val, y_val, x_test, y_test,
                                                                starting_percs,
                                                                nums_mols_to_add, 3, 5, 5, False)

density_final_rmse_df = pd.DataFrame(density_final_rmse_ls)
density_final_rmse_df.to_csv('redox_mdm_mcd_nr_5runs_RMSE_df.csv', header=False, index=False)
density_final_R2_df = pd.DataFrame(density_final_R2_ls)
density_final_R2_df.to_csv('redox_mdm_mcd_nr_5runs_R2_df.csv', header=False, index=False)
