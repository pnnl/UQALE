...
density_final_rmse_df.to_csv('sol_gbm_gbm_nr_5runs_RMSE_df.csv', header=False, index=False)
density_final_R2_df = pd.DataFrame(density_final_R2_ls)
density_final_R2_df.to_csv('sol_gbm_gbm_nr_5runs_R2_df.csv', header=False, index=False)
