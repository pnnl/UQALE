...
unc_perc_GNN_EDL, test_unc_in_bin_df_ls, test_unc_remain_df_ls, test_unc_in_bin_nr_df_ls, test_unc_remain_nr_df_ls = get_unc_result(train_X, val_X, train_loader, val_loader, test_loader_no_shuffle, pca_space_train, pca_space_val, pca_space_test, 3, 5, 1, get_test_uncertainty_GNN_EDL)

np.savez('sol_gnn_edl.npz', unc_perc_GNN_EDL, test_unc_in_bin_df_ls,
         test_unc_remain_df_ls,
         test_unc_in_bin_nr_df_ls,
         test_unc_remain_nr_df_ls)
