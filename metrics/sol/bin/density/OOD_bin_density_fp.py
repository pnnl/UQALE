...
unc_perc_density_fp, test_unc_in_bin_df_ls, test_unc_remain_df_ls, test_unc_in_bin_nr_df_ls, test_unc_remain_nr_df_ls = get_unc_result(similarity_test_fingerprint_np, 3,
                                     pca_space_train, pca_space_val, pca_space_test, 3, 5, 1, get_density_test_unc)
np.savez('sol_fp.npz', unc_perc_density_fp, test_unc_in_bin_df_ls,
         test_unc_remain_df_ls,
         test_unc_in_bin_nr_df_ls,
         test_unc_remain_nr_df_ls)
