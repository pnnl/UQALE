...
pubchem_max_pred = model.predict(pubchem_max_train)
MVE_unc_pubchem = np.array(pubchem_max_pred[:, 1])

print(spearmanr(MVE_unc_pubchem, pubchem_orig_sim))
print(pearsonr(MVE_unc_pubchem, pubchem_orig_sim))
