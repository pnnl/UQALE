...
target_pubchem, predicted_pubchem, predicted_unc_pubchem = test_func_MVE(pubchem_loader, model)

MVE_unc_pubchem = np.array(predicted_unc_pubchem)

spearmanr(MVE_unc_pubchem, pubchem_all_max_sim)
pearsonr(MVE_unc_pubchem, pubchem_all_max_sim)