...
target_pubchem, predicted_pubchem, predicted_v_pubchem, predicted_alpha_pubchem, predicted_beta_pubchem = test_func_edl(pubchem_loader, model)
data_uncertainty_pubchem = np.array(predicted_beta_pubchem)/(np.array(predicted_alpha_pubchem) - 1)
model_uncertainty_pubchem = np.array(predicted_beta_pubchem)/(np.array(predicted_v_pubchem)*(np.array(predicted_alpha_pubchem) - 1))
total_uncertainty_pubchem = data_uncertainty_pubchem + model_uncertainty_pubchem
...
print(spearmanr(total_uncertainty_pubchem, pubchem_orig_sim))
print(pearsonr(total_uncertainty_pubchem, pubchem_orig_sim))
