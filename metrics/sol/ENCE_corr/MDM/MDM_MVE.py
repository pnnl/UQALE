...
RMV_MVE_MDM, RMSE_MVE_MDM, ENCE_MVE_MDM = get_ENCE(y_test_pred[:, 1], 10, y_test_pred[:, 0], y_test)

print(ENCE_MVE_MDM)

pearson_corr_MVE, spearman_corr_MVE = get_correlation(y_test_pred[:, 1], y_test_pred[:, 0], y_test)
print(pearson_corr_MVE)
print(spearman_corr_MVE)
