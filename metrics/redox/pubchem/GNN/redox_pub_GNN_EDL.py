...
target_pubchem, predicted_pubchem, predicted_v_pubchem, predicted_alpha_pubchem, predicted_beta_pubchem = test_func_get_values(pubchem_loader, model)
...
spearmanr(total_uncertainty_pubchem, redox_pubchem['max_sim'])
pearsonr(total_uncertainty_pubchem, redox_pubchem['max_sim'])
