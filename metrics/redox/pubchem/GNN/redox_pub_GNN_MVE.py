...
target_pubchem, predicted_pubchem, predicted_unc_pubchem = test_func_MVE_test(pubchem_loader, model)
MVE_unc_pubchem = np.array(predicted_unc_pubchem)


# np.savetxt("MVE_unc_pubchem.csv", MVE_unc_pubchem, delimiter=",")
