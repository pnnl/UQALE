...
unc_perc_GNN_MVE, test_unc_in_bin_df_ls, test_unc_remain_df_ls, test_unc_in_bin_nr_df_ls, test_unc_remain_nr_df_ls = \
...
np.savez('redox_gnn_mve.npz', unc_perc_GNN_MVE, test_unc_in_bin_df_ls,
         test_unc_remain_df_ls,
         test_unc_in_bin_nr_df_ls,
         test_unc_remain_nr_df_ls)

print(pearsonr(err_perc_pc, unc_perc_GNN_MVE))
print(spearmanr(err_perc_pc, unc_perc_GNN_MVE))
